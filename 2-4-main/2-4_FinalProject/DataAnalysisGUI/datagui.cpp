    ...
    if (selection.toStdString().compare("Interest Based On Age") == 0){
        ...
        for (int i = 0; i < 110; i++){
            ...
            if (i%10 == 0 & i != 0){
                ...
                std::string entry = std::to_string(i-1) + "-" +std::to_string(i);
        ...
        if (selection2.indexOf("ar G") > 0){
            this->createBar(name,ageVal);
        }
        else{
            this->createPie(name,ageVal);
        }
        ...
        ageVal.push_back(total/count);
        response = db->getList(12,2,1,"Contacts");
        ...
        if (selection2.indexOf("ar G") > 0){
            this->createBar(name,ethDist());
        }

        else{
            this->createPie(name,ethDist());
        }
        ...
        if (selection2.indexOf("ar G") > 0){
            this->createBar(name,eduDist());
        }

        else{
            this->createPie(name,eduDist());
        }
...
void DataGui::createBar(std::vector<std::string> names,std::vector<double> data){
...
void DataGui::createPie(std::vector<std::string> names,std::vector<double> data){
    //ui->horizontalLayout.
...
//            }
//            if (data.compare("college") == 0 ){

//                cnt1 ++;


//            }
//            if (data.compare("masters") == 0){

//                cnt2 ++;


//            }
//            if (data.compare("doctorate") == 0 || data.compare("doctoral") == 0){
...
//            }
//            data2.push_back(cnt);
//            data2.push_back(cnt1);
//            data2.push_back(cnt2);
//            data2.push_back(cnt3);
//            data2.push_back(cnt4);
//            return data2;
