...
public:
     ...
     * \return
     */
    QString getLIDFromUserName(QString username);
     ...
     * \return
     */
    QString getRIDFromLID(QString lId, QString table);
    ...
    std::string dataBasePath = "./resources/project_db.sqlite";

    //stores user's login id
    int loginId;
